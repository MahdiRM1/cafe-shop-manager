...
export default function CategoryModal({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || "خطا در ذخیره‌سازی دسته بندی");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FormField label="نام دسته بندی" type="text" value={name} onChange={setName} required />
        <FormField label="ترتیب دسته بندی" type="number" value={displayOrder} onChange={setDisplayOrder} />
